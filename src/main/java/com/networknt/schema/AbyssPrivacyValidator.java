...
public class AbyssPrivacyValidator extends BaseJsonValidator implements JsonValidator {
    private static final Logger logger = LoggerFactory.getLogger(AbyssPrivacyValidator.class);

    private JsonType schemaType;
    private UnionTypeValidator unionTypeValidator;

    public AbyssPrivacyValidator(String schemaPath, JsonNode schemaNode, JsonSchema parentSchema, ValidationContext validationContext) {
        super(schemaPath, schemaNode, parentSchema, ValidatorTypeCode.X_ABYSS_PRIVACY, validationContext);
    ...
    public Set<ValidationMessage> validate(JsonNode node, JsonNode rootNode, String at) {
        ...
        System.out.println("Privacy Validator Invoked...");
/*
        if (schemaType == JsonType.UNION) {
